        ...
        >
            ...
            <div class="flex h-full flex-col">
                ...
                <div class="flex justify-between items-center p-4 border-b-2 border-slate-500/60 bg-slate-400">
                    <h2 class="text-white text-xl tracking-wider uppercase font-light">Update Promo Code</h2>
                    <button 
                        @click="show = false" 
                    ...
                    <form wire:submit.prevent="save" class="flex flex-col gap-4 h-screen">
                        <div>
                            <p class="italic text-md text-slate-500">
                                Update the promo code for this programme.
                                Updated promo code will immediately applicable to the programme as long as
                                it is active and within the date range validity.
                            </p>
                        </div>
                        <div class="space-y-4 flex flex-col gap-4">
                            <div>
                                <label class="mb-1 block text-sm font-medium text-black">Promo Code<span class="text-red-500 px-1">*</span></label>
                                <input 
                                    wire:model="code"
                                    type="text" 
                            ...
                            <div x-data="{ isActive: @entangle('isActive') }" class="flex">
                                <label :for="updatePromocode+$promocode->id" class="flex cursor-pointer select-none items-center">
                                    <span class="text-sm font-medium text-black mr-1">Status</span>
                                    <div class="relative">
                                        <input 
                                            wire:model="isActive"
                                            type="checkbox" :id="updatePromocode+$promocode->id" class="sr-only" />
