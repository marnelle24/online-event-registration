            ...
            @foreach ($ps as $key => $speaker)
                <div class="hover:bg-slate-100/50 duration-300 grid grid-cols-6 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
                    ...
                    <div class="col-span-2 flex items-center gap-2 justify-end">
                        <svg 
                            class="size-6 stroke-blue-500 hover:stroke-blue-500 hover:scale-110 duration-300 cursor-pointer"
                        ...
                        <svg 
                            ...
                            class="stroke-red-400 hover:stroke-red-600 w-6 h-6 cursor-pointer hover:scale-110 duration-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
