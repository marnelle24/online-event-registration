<div class="w-full">
    ...
    <div class="relative">
        ...
        @else
                ...
                x-data="{ 
                    ...
                    init() {
                        ...
                        window.addEventListener('resize', () => {
                            this.updateItemsPerView();
                            this.currentIndex = 0; // Reset to start on resize
                        });
                    },
                    updateItemsPerView() {
            ...
            >
                <!-- Carousel Container -->
                <div class="relative overflow-x-hidden py-4">
                    <!-- Carousel Track -->
                    <div 
                        class="flex transition-transform duration-500 ease-in-out gap-4 px-2 items-center justify-center"
                        :style="`transform: translateX(calc(-${currentIndex} * (100% / ${itemsPerView})))`"
                    >
                        @foreach($programmes as $programme)
                            <div class="flex-shrink-0 w-full md:w-[400px] shadow-md rounded-xl">
                                <div class="bg-white rounded-xl transition-all duration-300 transform hover:-translate-y-0.5 group">
                                    <!-- Programme Image -->
                                    ...
                                    <div class="p-6">
                                        <!-- Title -->
                                        <h3 class="font-bold text-2xl md:text-xl text-slate-900 mb-2">
                                        ...
                                        <div class="space-y-2 mb-4 mt-2">
                                            ...
                                            @if($programme->address)
                                                <div class="flex items-start text-base text-slate-800">
                                                    ...
                                                    <span class="capitalize">{{ Str::words($programme->location, 5, '...') }}</span>
                                                </div>
                                            @endif
                ...
                <!-- Navigation Buttons -->
                <div x-show="totalItems > itemsPerView">
                    <!-- Previous Button -->
                    <button
                        @click="prev()"
                        :disabled="!canGoPrev()"
                        :class="{ 'opacity-50 cursor-not-allowed': !canGoPrev(), 'opacity-100 hover:bg-teal-600': canGoPrev() }"
                        class="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 bg-teal-500 text-white p-3 rounded-full shadow-lg transition-all duration-300 z-10 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
                    ...
                    <button
                        ...
                        class="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 bg-teal-500 text-white p-3 rounded-full shadow-lg transition-all duration-300 z-10 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
