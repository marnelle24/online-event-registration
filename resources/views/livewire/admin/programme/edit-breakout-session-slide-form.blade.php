<div x-data="{ show: false }" @close-modal.window="show = false">
    <div x-data="{ showToolTip: false }" class="relative flex items-center gap-3">
        ...
        {{-- add tooltip --}}
        <div x-show="showToolTip" x-transition class="absolute top-4 left-3 transition-all duration-300 ease-in-out hover:opacity-100 hover:translate-y-0 bg-slate-800 text-white text-xs rounded px-2 py-1 shadow-lg z-50">
            Update
        </div>
    </div>
