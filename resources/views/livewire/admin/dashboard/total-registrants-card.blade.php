<div class="bg-white shadow-md rounded-lg border border-slate-300 p-6 hover:shadow-lg transition-shadow">
    <div class="flex items-center justify-between">
        <div>
            <p class="text-sm text-slate-500 mb-1">Total Registrants</p>
            <p class="text-3xl font-bold text-slate-800">{{ number_format($totalRegistrants) }}</p>
            <p class="text-xs text-slate-400 mt-1">{{ $recentRegistrations }} in last {{ $selectedPeriod }} days</p>
        </div>
