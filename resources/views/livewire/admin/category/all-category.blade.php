<div>
    ...
    <div class="flex justify-between gap-3 mb-8 lg:flex-row flex-col lg:items-center items-start">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-3">
            ...
            @livewire('admin.category.add-category', key('add-new-category'))
        </div>
    </div>
            ...
            <table class="w-full table-auto">
                <thead>
                    <tr class="bg-slate-200 border border-slate-300 text-slate-500 text-left">
                        ...
                        <th class="p-4 font-bold text-nowrap">
                            Slug
                        </th>
                        <th class="p-4 font-bold text-nowrap">
                            Programmes
                                ...
                                <td class="p-4 pl-6 w-[25%]">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex flex-col">
                                            <span class="font-bold text-slate-800 capitalize truncate">
                                                {{ $category->name }}
                                            </span>
                                        </div>
                                    </div>
    ...
    @livewire('admin.category.edit-category', key('edit-category'))
