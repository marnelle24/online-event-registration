<div class="relative" x-data="{ show: false }" @close-modal.window="show = false" x-on:newAddedUser.window="$nextTick(() => show = false)">
    <button 
        @click="show = true" 
        class="w-full flex items-center justify-center gap-2 shadow border border-blue-600/30 bg-slate-600 drop-shadow text-slate-200 hover:bg-slate-700 rounded-full hover:-translate-y-0.5 duration-300 py-2 px-4">
