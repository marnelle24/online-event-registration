                        ...
                        <form wire:submit.prevent="save" class="flex flex-col gap-4 h-screen">
                            ...
                            <div class="space-y-4 flex flex-col gap-4">
                                ...
                                <div x-data="{ isActive: @entangle('isActive') }" class="flex">
                                    <label for="promotionStatus" class="flex cursor-pointer select-none items-center">
                                        <span class="text-sm font-medium text-black mr-1">Status</span>
                                        <div class="relative">
                                            <input 
                                                wire:model="isActive"
                                                type="checkbox" id="promotionStatus" class="sr-only" />
                                ...
                                @endif
                                    <label for="promotion-is-group-edit" class="text-base font-semibold text-black">Group Promotion</label>

                                    <div class="flex items-center justify-between">
                                        <p class="text-sm text-slate-500 italic">Enable if this promotion applies to group registrations only.</p>
                                        <label for="promotion-is-group-edit" class="flex cursor-pointer select-none items-center">
                                            <div class="relative">
                                                <input 
                                                    wire:model="isGroup"
                                                    type="checkbox" 
                                                    id="promotion-is-group-edit" 
                                                    class="sr-only" 
                                                />
                                ...
                                >
                                    <div>
                                        ...
                                        />
                                        @error('minGroup')
                                            <span class="text-red-500 text-xs">{{ 'Minimum group size is required' }}</span>
                                        @enderror
                                    </div>
                                    <div>
                                        ...
                                        />
                                        @error('maxGroup')
                                            <span class="text-red-500 text-xs">{{ 'Maximum group size is required' }}</span>
                                        @enderror
                                    </div>
                                </div>
                                </div>
