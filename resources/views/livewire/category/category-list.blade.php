        ...
        <div class="rounded-sm border border-stroke dark:border-strokedark">
            <div class="max-w-full overflow-x-auto">
                <table class="w-full table-auto">
                    <thead>
                        <tr class="bg-neutral-100 dark:bg-neutral-900/20 text-zinc-900 dark:text-zinc-100 text-left border-b border-slate-200 dark:border-white/40">
                            <th class="p-6 font-bold text-slate-600 dark:text-white xl:pl-11">
                                Name
                            </th>
                    ...
                    <tbody>
                        @if( count($categories) )
                            @foreach ($categories as $key => $category)
                                <tr wire:key="{{$key}}" class="hover:bg-neutral-100 dark:hover:bg-neutral-800/10 duration-300 border-b border-neutral-200/50 dark:border-neutral-400/50">
                                    <td class="p-4 pl-9 dark:border-strokedark xl:pl-11">
                                    ...
                                    <td class="px-4 py-5 dark:border-strokedark">
                                        <div class="flex justify-end items-center space-x-3.5">
                                            <button class="text-primary dark:text-neutral-300 hover:-translate-y-0.5 duration-300" wire:click="selectCategory({{$category}})">
                                            ...
                                            <button class="text-danger dark:text-neutral-300 hover:-translate-y-0.5 duration-300" wire:click="deleteCategory({{$category->id}})" wire:confirm="Are you sure you want to delete this category?">
                                                <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
