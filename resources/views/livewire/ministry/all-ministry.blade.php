<div>
    ...
    <div class="flex justify-between gap-3 mb-8 lg:flex-row flex-col lg:items-center items-start">
        ...
        <div class="flex lg:gap-3 gap-1">
            ...
            @livewire('ministry.add-ministry', key('add-new-ministry'))
        </div>
    </div>
    ...
    @livewire('ministry.edit-ministry', key('edit-ministry'))
@livewire('ministry.manage-users-modal', key('manage-users-modal'))
