<x-guest-layout>
    ...
    <div class="bg-white">
        <div class="flex justify-center items-center">
            <div class="w-[550px] p-4 sm:p-12.5 xl:p-17.5">
                <span class="mb-4 block font-thin text-center">Welcome back!</span>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="block mb-6">
                        <label for="remember_me" class="flex items-center">
                            <x-checkbox id="remember_me" name="remember" class="rounded-none" />
