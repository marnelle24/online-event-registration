...
<div class="flex flex-col" x-data="inputImage('{{$defaultImage}}')">
    ...
    <div :class="{ 'bg-gray border p-4 rounded border-dashed border-primary' : !imagePreview }"
        {!! $attributes->merge(['class' => 'mb-4 flex justify-center items-center']) !!} x-transition
        class="relative mb-5.5 block w-full cursor-pointer appearance-none rounded bg-gray px-4 py-4 sm:py-7.5">
