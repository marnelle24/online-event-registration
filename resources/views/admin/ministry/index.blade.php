...
<x-app-layout>
    <div class="flex gap-3">
        <h4 class="text-2xl font-bold text-black dark:text-slate-600 mb-8 capitalize">Ministry Management</h4>
    </div>
            ...
            <div class="flex gap-3 border border-slate-400/60 dark:border-slate-300/60 shadow-sm rounded-md p-4 bg-zinc-200 dark:bg-slate-700">
                ...
                <div>
                    ...
                    <div>
                        <table>
                            <tr>
                                <td class="text-sm py-1 text-slate-600 dark:text-white" width="150">Contact Person</td>
                                <td class="text-sm py-1 text-slate-600 dark:text-white">: {{ $ministry->contactPerson }}</td>
                            </tr>
                            <tr>
                                <td class="text-sm py-1 text-slate-600 dark:text-white">Contact Number</td>
                                <td class="text-sm py-1 text-slate-600 dark:text-white">: {{ $ministry->contactNumber }}</td>
                            </tr>
                            <tr>
                                <td class="text-sm py-1 text-slate-600 dark:text-white">Email</td>
                                <td class="text-sm py-1 text-slate-600 dark:text-white">: {{ $ministry->contactEmail }}</td>
                            </tr>
                            <tr>
                        ...
                        <div class="mt-4 mb-2">
                            <button class="bg-slate-500 dark:bg-slate-100 hover:-translate-y-0.5 hover:bg-slate-600 dark:hover:bg-slate-300 transition-all duration-300 shadow text-xs text-white dark:text-slate-600 px-4 py-2 rounded-full">
