...
<x-app-layout>
    <h4 class="text-2xl font-bold text-slate-600 dark:text-slate-600 capitalize mb-2">Update Programme</h4>
    ...
    {{-- @dd($programme->getAttributes(), $programme->ministry->getAttributes(), $programme->categories->toArray()) --}}
        
    <form class="flex flex-col gap-4" action="{{route('admin.programmes.update', $programme->id)}}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf
                ...
                <div class="shadow-md p-6 border border-slate-400/70 rounded bg-white flex lg:flex-row flex-col w-full gap-4 justify-between">
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex">
                            <input 
                                {{-- readonly --}}
                                name="programmeCode" 
                                value="{{old('programmeCode', $programme->programmeCode)}}" 
                    ...
                    <div class="flex flex-col lg:w-1/3 w-full">
                        ...
                        <select 
                            ...
                            <option {{ old('type', $programme->type) === 'event' ? 'selected' : '' }} value="event">Event</option>
                            <option {{ old('type', $programme->type) === 'course' ? 'selected' : '' }} value="course">Course</option>
                        </select>
                    </div>
                </div>
                <div class="shadow-md p-6 border border-slate-400/70 rounded bg-white flex gap-4 w-full">
                    <div class="flex flex-col w-full">
                        ...
                        <textarea 
                            ...
                            placeholder="Title of the Programme">{{old('title', $programme->title)}}</textarea>
                    </div>
                </div>
                <div class="shadow-md p-6 border border-slate-400/70 rounded bg-white flex flex-col gap-4">
                    <div class="flex flex-col">
                        ...
                        <textarea 
                            ...
                            class="min-h-[200px] focus:border-neutral-400 focus:ring-0 flex items-center whitespace-nowrap rounded-md bg-zinc-50 border border-solid border-neutral-400/70 px-3 py-2 text-base font-normal text-surface">{{ old('description', $programme->description) }}</textarea>
                    </div>
                </div>
                {{-- schedule --}}
                    ...
                    <div class="flex lg:flex-row flex-col gap-6 bg-zinc-100 border border-zinc-200/60 p-4">
                        <div class="flex flex-col gap-4 lg:w-1/2 w-full">
                            ...
                            <div class="flex lg:flex-row flex-col lg:items-center items-start gap-4 w-full">
                                ...
                                <x-input 
                                    type="date" 
                                    name="startDate" 
                                    value="{{old('startDate', $programme->startDate)}}" 
                                ...
                                <x-input 
                                    type="date" 
                                    name="endDate" 
                                    value="{{old('endDate', $programme->endDate)}}" 
                        ...
                        <div class="flex flex-col gap-4 lg:w-1/2 w-full">
                            ...
                            <textarea 
                                ...
                                placeholder="Alternative content to display a date in landing page.">{{old('customDate', $programme->customDate)}}</textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex flex-col gap-4">
                                <div class="flex flex-col">
                                    ...
                                    <textarea 
                                        ...
                                        placeholder="Bldg No./Street No./Block #">{{old('address', $programme->address)}}</textarea>
                                </div>
                                <div class="flex justify-between gap-4">
                                    ...
                                    <div class="flex flex-col w-full">
                                        ...
                                        <input 
                                            name="postalCode" 
                                            value="{{old('postalCode', $programme->postalcode)}}" 
                        ...
                        <div class="xl:w-1/2 w-full flex flex-col gap-4">
                            <label class="flex items-center space-x-2">
                                <input 
                                    ...
                                    name="isOnline" 
                                    value="true" 
                                    {{ old('isOnline', $programme->onlineHybrid) ? 'checked' : '' }}
                            ...
                            <div class="flex flex-col gap-1 w-full">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Online platform url (Zoom, Google Meet, Whatsapp, etc.)">{{old('onlineLink', $programme->onlineDetails)}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex flex-col w-full gap-1">
                            <div class="flex gap-2 items-center">
                                ...
                                <div class="w-full">
                                    ...
                                    <input 
                                        name="contactPerson" value="{{old('contactPerson', $programme->contactPerson)}}"
                        ...
                        <div class="flex flex-col w-full gap-1">
                            <div class="flex gap-2 items-center">
                                ...
                                <div class="w-full">
                                    ...
                                    <input 
                                        name="contactEmail" value="{{old('contactEmail', $programme->contactEmail)}}"
                        ...
                        <div class="flex flex-col w-full gap-1">
                            <div class="flex gap-2 items-center">
                                ...
                                <div class="w-full">
                                    ...
                                    <input 
                                        name="contactNumber" value="{{old('contactNumber', $programme->contactNumber)}}"
            ...
            <div class="xl:w-1/4 w-full flex flex-col gap-4">
                ...
                <div class="shadow-md p-4 border border-slate-400/70 rounded bg-white">
                    ...
                    <div class="relative mb-4 flex flex-wrap items-stretch">
                        ...
                        <input
                            type="text"
                            name="price"
                            value="{{old('price', $programme->price)}}"
                    ...
                    <input
                        type="text"
                        name="adminFee"
                        value="{{old('adminFee', $programme->adminFee)}}"
                        class="relative m-0 block flex-auto rounded-r-md bg-zinc-50 border border-l-0 border-solid border-neutral-400/70 focus:ring-0 bg-clip-padding px-3 py-2 text-base font-normal leading-[1.6] text-surface outline-none transition duration-200 ease-in-out placeholder:text-neutral-500 focus:z-[3] focus:border-neutral-400 focus:shadow-inset focus:outline-none motion-reduce:transition-none"
                ...
                <div class="shadow-md p-4 border border-slate-400/70 rounded bg-white">
                    ...
                    <input 
                        ...
                        name="externalUrl" 
                        value="{{old('externalUrl', $programme->externalUrl)}}" 
                        type="text" 
                ...
                <div class="shadow-md p-4 border border-slate-400/70 rounded bg-white">
                    ...
                    <label class="flex items-center space-x-2 mb-1">
                        <input type="checkbox" name="private_only" value="1" {{ old('private_only', $programme->private_only) ? 'checked' : '' }} class="form-checkbox text-blue-600 rounded-none focus:outline-none focus:ring-0">
                        <span>Private Only</span>
                    </label>
                    <label class="flex items-center space-x-2 mb-1">
                        <input type="checkbox" name="searchable" value="1" {{ old('searchable', $programme->searchable) ? 'checked' : '' }}  class="form-checkbox text-blue-600 rounded-none focus:outline-none focus:ring-0">
                        <span>Searchable</span>
                    </label>
                    <label class="flex items-center space-x-2 mb-1">
                        <input type="checkbox" name="publishable" value="1" {{ old('publishable', $programme->publishable) ? 'checked' : '' }} class="form-checkbox text-blue-600 rounded-none focus:outline-none focus:ring-0">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="limit" 
                            value="{{old('limit', $programme->limit)}}" 
                            type="number" 
                            placeholder="0" 
                        />
                    </div>
                    <div class="mt-4">
                        ...
                        <input 
                            ...
                            name="activeUntil" 
                            value="{{old('activeUntil', $programme->activeUntil)}}" 
                            type="datetime-local" 
                        />
                    </div>
                </div>
                        ...
                        @foreach ($categories as $key => $value)
                            <label class="flex items-center gap-2 my-1">
                                <input 
                                    ...
                                    name="categories[]" 
                                    value="{{ $key }}"
                                    {{ $programme->categories->contains($key) ? 'checked' : '' }}>
                                {{ $value }}
                            </label>
                        @endforeach
                    </div>
                ...
                <div class="@error('thumb') border-red-600 @enderror shadow-md p-4 border border-slate-400/70 rounded-none bg-white">
                    <x-upload-image 
                        class="bg-zinc-200/70 min-h-[150px] border-zinc-400/40" 
                        emptyLabel="Thumbnail" 
                        name="thumb"
                        defaultImage="{{$programme->thumbnail}}"
                    />
                </div>
