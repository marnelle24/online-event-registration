...
<x-app-layout>
    ...
    <div class="flex gap-4 w-full mt-4">
        ...
        @if(request('p') === 'dashboard' || !request('p'))
            <div class="lg:px-0 px-4 py-8 w-full">
                <div class="grid grid-cols-1 lg:grid-cols-4 sm:grid-cols-2 gap-4">
                    ...
                    <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default">
                        <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2">
                            <svg class="fill-primary" width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            <h4 class="text-title-md font-bold text-black">140</h4>
                    ...
                    <div class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default">
                        <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2">
                            <svg class="fill-primary" width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="mt-4 flex items-end justify-between">
                        <div>
                            <h4 class="text-title-md font-bold text-black">$3.456K</h4>
                ...
                <br />
                <div class="col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default sm:px-7.5 xl:col-span-8">
    ...
    @push('script')
        @vite('resources/js/programme-dashboard-graph.js')
        <script>
