                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex">
                            <input 
                                ...
                                class="focus:border-neutral-700 w-full focus:ring-0 flex items-center whitespace-nowrap rounded-md bg-zinc-50 border border-solid border-neutral-400/70 px-3 py-2 text-base font-normal text-surface" 
                                type="text" 
                    ...
                    <div class="flex lg:flex-row flex-col justify-between gap-4 bg-zinc-100 border border-zinc-200/60 p-4">
                        <div class="xl:w-1/2 w-full flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-4">
                                <div class="flex flex-col">
                                    <p class="text-xs text-slate-500 capitalize">Address</p>
                                    <textarea 
                                        name="address"
                                ...
                                <div class="flex justify-between gap-4">
                                    <div class="flex flex-col w-full">
                                        <p class="text-xs text-slate-500 capitalize">City</p>                                    
                                        <input 
                                            name="city" 
                                            value="{{old('city', $city)}}" 
                                    ...
                                    <div class="flex flex-col w-full">
                                        <p class="text-xs text-slate-500 capitalize">Postal Code</p>    
                                        <input 
                                            name="postalCode" 
                        ...
                        <div class="xl:w-1/2 w-full flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-1 w-full">
                                <p class="text-xs text-slate-500 capitalize">Online Platform Details</p> 
                                <textarea 
                                    name="onlineDetails"
            ...
            <div class="xl:w-1/4 w-full flex flex-col gap-4">
                ...
                <div class="shadow-md p-4 border border-slate-400/70 rounded bg-white">
                    ...
                    <label class="flex items-center space-x-2 mb-1">
                        <input type="checkbox" name="private_only" value="1" {{ old('private_only', '1') ? 'checked' : '' }} class="form-checkbox text-blue-600 rounded-none focus:outline-none focus:ring-0">
